  ...
  return (
    <div   id="profile" className='h-[98vh] flex flex-col p-4'>
      ...
      <div className=' h-full flex sm:flex-nowrap flex-wrap justify-around gap-2 sm:gap-8 items-center '>
        <m.img whileHover={{scale:1.05}} whileTap={{rotate:4}} animate={!loading ?{y:0} :{}} initial={{y:-500}} transition={{ type:"spring" ,stiffness:120}} onLoad={imageLoaded} className='rounded-full  shadow-md  shadow-secondary ' width={'300'} src="images/IMG_20230411_153707_085.jpg" alt="ramache zoubir" />
